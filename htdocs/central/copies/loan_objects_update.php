...
$Expresion="CN_".$arrHttp["base"]."_".$arrHttp["cn"];
...
<div class="sectionInfo">
	...
	<div class="actions">
		<a href=copies_edit_browse.php?Expresion=CN_<?php echo $arrHttp["base"]."_". $arrHttp["cn"]?> class="defaultButton backButton">
