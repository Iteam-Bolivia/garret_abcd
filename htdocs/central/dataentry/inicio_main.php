...
if (isset($arrHttp["base"])){
	...
	echo "<HTML><title>Abogados</title>
<head>
...
function TipoDeRegistro(){
	...
	return
	top.frames[2].document.writeln("<html><body style='font-family:'>")
...
<frameset rows=98,45,* cols=* border=0>
<?php
if (isset($arrHttp["base"])){
...
<frame src="UntitledFrame-1"><frame src="UntitledFrame-2"><frame src="UntitledFrame-3"></frameset><noframes></noframes>
</HTML>
