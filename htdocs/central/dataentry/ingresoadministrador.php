...
echo "<table border=0 width=100%><td width=20> </td><td>" ;
if (isset($arrHttp["error"])) echo $arrHttp["error"];
$xnr="";
$xtl="";
$Rtl="";
$Rnr="";
if (isset($default_values)){	echo "<span class=title>".$msgstr["valdef"]."</span>";
...
if (!isset($fmt_test) and !isset($default_values)) {  //Para indicar que se está haciendo el test de la hoja de entrada o creando valores por defecto
	...
	if (!$ver or isset($arrHttp["capturar"])){
		...
		if (isset($arrHttp["capturar"]) and $arrHttp["capturar"]=="S"){            echo "<td align=center ><a href=\"javascript:CapturarRegistro()\"><img src=img/capturar.gif border=0 alt=\"".$msgstr["m_capturar"]."\"></a></td>\n";		}else{

			if (!isset($arrHttp["encabezado"])){
				echo "<td align=center ><a href=\"javascript:EnviarForma()\"><img src=img/barSave.png border=0 alt=\"".$msgstr["actualizar"]."\"></a></td>\n";
				if (!isset($arrHttp["ventana"])){
					echo "<td align=center ><a href=javascript:CancelarActualizacion()><img src=img/barCancelEdit.png border=0 alt=\"".$msgstr["cancelar"]."\"></a></td>\n";
				 	echo "<td align=center ><a href=javascript:EliminarRegistro()><img src=img/barDelete.png border=0 alt=\"".$msgstr["eliminar"]."\"></a></td>\n";
				}
			}
		}
		echo "</table>\n";
