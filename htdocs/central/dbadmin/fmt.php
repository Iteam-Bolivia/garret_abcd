...
?>
    </select> <a href=javascript:EditarFormato()><?php echo $msgstr["edit"]?></a> | <a href=javascript:EliminarFormato()><?php echo $msgstr["delete"]?></a>
    </td>
<?php
//READ THE OPERATORS DATABASE TO CHECK WHICH ONES HAS RIGHTS TO THE DATABASE
$IsisScript=$xWxis."leer_mfnrange.xis";
$Formato="v10'|',v20,'|',v100+|;|/" ;
$query = "&base=acces&cipar=$db_path"."par/acces.par&from=1&Pft=$Formato";
include("../common/wxis_llamar.php");
$size=count($contenido);
?>
</table>
<p>
<table border=1>
